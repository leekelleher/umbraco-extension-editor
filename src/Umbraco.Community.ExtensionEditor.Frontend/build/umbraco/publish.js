...
export default function publish() {
    ...
    const solutionPath = join(rootDir, 'Umbraco.Community.ExtensionEditor.sln');
    const projectPath = join(rootDir, 'Umbraco.Community.ExtensionEditor.Backend');
    const csprojectPath = join(projectPath, 'Umbraco.Community.ExtensionEditor.Backend.csproj');
